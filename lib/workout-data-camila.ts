...
export const workoutData: WorkoutData = {
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            sets: "2 x 30-45s c/l",
            rest: "30s",
            notes: "Estabilidad lateral (oblicuos); realiza una serie por lado",
            type: "Isométrico",
  ...
  5: {
    ...
    dayOfWeek: 5,
    warmup: "Cardio ligero + colgarse en barra 30 s (si tienes) + series suaves de remo y curl.",
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            sets: "1 x 21",
            rest: "90s",
            notes: "Finisher opcional de alta congestión",
            type: "Aislado",
